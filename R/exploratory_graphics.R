...
cols_31 = c("#69006f","#62e622","#cf00d0","#00a60c","#8568ff","#01e479",
            ...
            "#695000")
acols_60 = rev(c("#f44400","#6151fe","#66f035","#3015be","#c2ff29","#7d00be",
...
cols_60 = c("#005981","#71e000","#5b4cf8","#d0e400","#6600b2","#01c54e",
...
cols_70 = c("#00cf9b","#fc00bf","#52e62c","#a000b2","#9fff37","#5066ff",
...
#'   FALSE, they are added. Just gets passed to \code{prop_tax_row()}.
#'
#' @keywords internal
...
#'
#' @param phy_df A phyloseq data frame, as generated by \code{psmelt()} or
#'   \code{make_phy_df()}
...
#' \code{abunds} column.
#'
#' @param phy_df A phyloseq data frame, as generated by \code{psmelt()}, but
#'   probably generated by \code{df_glom()}.
