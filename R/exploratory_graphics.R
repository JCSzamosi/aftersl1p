...
#' @param dada2 (\code{FALSE}) Specifies whether the data came from dada2 or
#'   sl1p. Determines what the taxonomic ranks are.
df_glom = function(phy_df, IDcol = 'X.SampleID', rank = 'Phylum',
                   abunds = 'Abundance', dada2 = FALSE){
    # Ranks
    if (dada2){
        ranks = c('Kingdom','Phylum','Class','Order','Family','Genus','Species')
    } else {
        ranks = c('Root1','Phylum','Class','Order','Family','Genus','Species')
    }
...
subset_order = function(phy_df, varbs = NULL, bases = NULL, rank = 'Genus',
                        abunds = 'TotalAbunds', dada2 = FALSE){
    # Check inputs
    if (is.null(varbs)){
