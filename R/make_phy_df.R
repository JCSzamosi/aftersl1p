...
#'   \code{\link[phyloseq]{psmelt}}, but with an 'Other' category added and
...
#'   table (default, \code{TRUE}) or if this has already been done.
#' @param count If \code{FALSE} (default) the function will expect a relative
