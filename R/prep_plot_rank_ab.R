...
#'   \code{\link[phyloseq]{psmelt}} or \code{\link{make_phy_df}}
...
#' \code{\link{rank_abund}}
#'
#' @param phy_df A phyloseq data frame, as generated by
#'   \code{\link[phyloseq]{psmelt}}, but probably generated by
#'   \code{\link{df_glom}} or
...
#' @param rank (\code{'Genus'}) The taxonomic rank to base the ordering on.
...
#'
#' \code{\link{df_glom}} take totals within sample at a given taxonomic rank.
#'
#' @param phy_df A phyloseq data frame, as generated by
#'   \code{\link[phyloseq]{psmelt}} or \code{\link{make_phy_df}}
